define({ "api": [
  ...
  },
  {
    ...
    "name": "getComments",
    "group": "Comments",
    "description": "<p>Retrieves a paginated list of comments of a document</p>",
    "version": "0.0.0",
    "filename": "api/document.js",
    "groupTitle": "Comments"
  },
  {
    ...
    "title": "Get an array of comments by IDs",
    "name": "getSomeComments",
    "group": "Comments",
    "description": "<p>You can get an array of comments of a document, no matter the field, you just need to specify in the querystring a key-value pair with key <code>ids</code> and an Stringified array of ids. Please, remember to user Array.prototype.join(',') the allowed format is <code>?ids=idExample1,idExample2,idExample3</code>.</p>",
    "permission": [
      {
        "name": "authenticated",
        "title": "Must be authenticated",
